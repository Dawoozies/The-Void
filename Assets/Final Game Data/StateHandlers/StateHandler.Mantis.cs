            ...
            if(mantis != null)
            {
                if(mantis.animator.CurrentState("Mantis_AimAtPlayer"))
                {
                    ...
                    if (mantis.animator.trueTimeSpentInState > 0.28f)
                        pose = 3;
                    mantis.legs.animator.animator.Play($"MantisLegs_WindUp1_Pose{pose}");
                    mantis.torso.animator.animator.Play($"MantisTorso_WindUp1_Pose{pose}");
                ...
                if(mantis.animator.CurrentState("Mantis_LinearStrike"))
                {
                    ...
                    if (mantis.animator.trueTimeSpentInState > 0.14f)
                        pose = 3;
                    mantis.legs.animator.animator.Play($"MantisLegs_Attack1_Pose{pose}");
                    mantis.torso.animator.animator.Play($"MantisTorso_Attack1_Pose{pose}");
                ...
                if(mantis.animator.CurrentState("Mantis_LinearRetract"))
                {
                    ...
                    if(pose <= 2)
                    {
                        mantis.legs.animator.animator.Play($"MantisLegs_AttackEnd1_Pose{pose}");
                        mantis.torso.animator.animator.Play($"MantisTorso_AttackEnd1_Pose{pose}");
                    }
