...
namespace RuntimeObjects
{
    public class HangedFrame : RuntimeObject
    {
        ...
        public HangedFrame(string id) : base(id)
        {
            ...
            GameManager.ins.allRuntimeObjects.Add(head);
            ...
            GameManager.ins.allRuntimeObjects.Add(leftHand);
            ...
            GameManager.ins.allRuntimeObjects.Add(rightArm);
            ...
            GameManager.ins.allRuntimeObjects.Add(rightHand);
