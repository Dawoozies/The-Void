        ...
        if(Selection.transforms.Length > 0)
        {
            ...
            if (animationClip != null)
            {
                ...
                if (results.Length <= 0)
                {
                    ...
                    if(!AssetDatabase.IsValidFolder("Assets/AnimationClipCollisionData"))
                    {
                        AssetDatabase.CreateFolder("Assets", "AnimationClipCollisionData");
                    }

                    AssetDatabase.CreateAsset(collisionDataAsset, $"Assets/AnimationClipCollisionData/{animationClip.name}_CollisionData.asset");
